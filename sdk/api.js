...
module.exports = {
  abi: {
    call: (options) => abi('call', {
      ...options
    }),
    multiCall: (options) => abi('multiCall', {
      ...options,
      chunk: {
        param: 'calls',
        length: 5000,
  ...
  cdp: {
    ...
    compound: {
      tokens: (options) => compound('tokens', {
        ...options
      }),
    ...
    kava: {
      ...
      getAssetsLocked: (options) => kava('getAssetsLocked', {
        ...options,
        chunk: {
          param: 'targets',
          length: 1000,
  ...
  util: {
    ...
    toSymbols: (data) => util('toSymbols', {
      data
    }),
    unwrap: (options) => util('unwrap', {
      ...options
    }),
    lookupBlock: (timestamp) => util('lookupBlock', {
      timestamp
    })
  },
  eth: {
  ...
  erc20: {
    info: (target) => erc20('info', {
      target
    }),
    symbol: (target) => erc20('symbol', {
      target
    }),
    decimals: (target) => erc20('decimals', {
      target
    }),
    totalSupply: (options) => erc20('totalSupply', {
      ...options
    }),
